<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChinh.master" AutoEventWireup="true" CodeFile="Drink.aspx.cs" Inherits="PC" %>
...
<p style="background-color:lightyellow; width: 1179px; margin-right: 0px;">
    ...
    <p>
        <asp:DataList ID="DataList1" runat="server" BackColor="LightBlue" DataSourceID="SqlDataSource1" RepeatColumns="4" CellPadding="10" CellSpacing="10" OnItemCommand="DataList1_ItemCommand">
            <ItemTemplate>
                <asp:Image ID="Image1" runat="server" ImageUrl='<%# "Image/"+Eval("HINHANH") %>' Height="174px" Width="207px" />
<br />
                <asp:Label ID="Label4" runat="server" Font-Bold="True" ForeColor="#ff0066" Text='<%# Eval("DONGIA") %>'></asp:Label>
                <asp:Label ID="Label6" runat="server" Font-Bold="True" ForeColor="#ff0066" Text='<%# " VNĐ" %>'></asp:Label>
                <br />
